...
export function InfoIcon(props: {class: string}) {
    return <svg class={props.class} xmlns="http://www.w3.org/2000/svg" width="1.2rem" height="1.2rem" viewBox="0 0 24 24">
        <path fill="currentColor"
...
export function SuccessIcon(props: {class?: string}) {
    return <svg class={props.class} xmlns="http://www.w3.org/2000/svg" width="1.2rem" height="1.2rem" viewBox="0 0 1024 1024">
        <path fill="currentColor"
