...
const columns = [
    ...
    projectFullBuild("WindowsNightly", "Windows", "Nighly Windows build uploaded to Google Drive", () => <WinIcon/>),
    projectFullBuild("WindowsWeekly", "Windows", "Weekly Windows build  uploaded to Google Drive", () => <WinIcon/>),
